    ...
    <div className={"card mb-2 shadow border-"+prioridadeStyle(props.ativ.prioridade)}>
            <div className="card-body">
              ...
              <div className="d-flex justify-content-end pt-2 m-0 border-top">
                  <button className="btn btn-outline-primary me-2 btn-sm" onClick={()=> props.pegarAtividade(props.ativ.id)}>
                    <i className="fas fa-pen me-2"></i>
                    Editar
                  </button>
                  <button className="btn btn-outline-danger me-2 btn-sm" onClick={()=> props.deletarAtividade(props.ativ.id)}>
